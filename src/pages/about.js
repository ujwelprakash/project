...
function About() {
    return ( < div >
        ...
        p className = "pt-3"
        style = {
            { color: 'white', fontSize: '25px' } } > Anurag < /p> <
        /div> <
        ...
        p className = "pt-3"
        style = {
            { color: 'white', fontSize: '25px' } } > Devaki < /p> <
        /div> <
        div className = "col-lg-4 col-sm-12" >
        <
        img style = {
        ...
        p className = "pt-3"
        style = {
            { color: 'white', fontSize: '25px' } } > Arunima < /p> <
        /div> <
        div className = "col-lg-4 col-sm-6" >
        <
        img style = {
        ...
        p className = "pt-3"
        style = {
            { color: 'white', fontSize: '25px' } } > james < /p> <
        /div>
        ...
        p className = "pt-3"
        style = {
            { color: 'white', fontSize: '25px' } } > Arun < /p> <
        /div>
